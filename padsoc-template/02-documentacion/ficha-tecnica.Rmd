...
rmarkdown::render(input = here::here("padsoc-template/02-documentacion/ficha-tecnica.Rmd"),
                  output_dir = here::here("padsoc-template/02-documentacion"))
```
...
load(here::here("padsoc-template/02-documentacion/input/cep_sexo.RData"))
load(here::here("padsoc-template/02-documentacion/input/cep_edadcat.RData"))
load(here::here("padsoc-template/02-documentacion/input/cep_educat.RData"))
...
# educacion
study_w01$edcat2 <- car::recode(study_w01$edcep,recodes = "7:8=7;8=9;9=8") 
  # homologar etiquetas
