...
rmarkdown::render(input = here::here("padsoc-template/99-plantillas/ficha-tecnica.Rmd"),
...
load(here::here("padsoc-template/99-plantillas/input/cep_sexo.RData"))
load(here::here("padsoc-template/99-plantillas/input/cep_edadcat.RData"))
load(here::here("padsoc-template/99-plantillas/input/cep_educat.RData"))
...
survey_info <- 
  readxl::read_excel(here::here("padsoc-template/99-plantillas/input/survey-info.xlsx"))
